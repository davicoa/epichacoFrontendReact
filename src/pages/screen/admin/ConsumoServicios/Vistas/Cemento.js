...
const Cemento = (props) => {
  ...
  const [valor_sin_est_chaco, setValor_sin_est_chaco] = useState(typeof obj !== "undefined" ? obj.valor_sin_est_chaco : "");
  const [var_mens_s_e_chaco, setVar_mens_s_e_chaco] = useState(typeof obj !== "undefined" ? obj.var_mens_s_e_chaco : "");
  const [var_ia_s_e_chaco, setVar_ia_s_e_chaco] = useState(typeof obj !== "undefined" ? obj.var_ia_s_e_chaco : "");
  const [valor_sin_est_nacion, setValor_sin_est_nacion] = useState(typeof obj !== "undefined" ? obj.valor_sin_est_nacion : "");
  const [var_mens_s_e_nacion, setVar_mens_s_e_nacion] = useState(typeof obj !== "undefined" ? obj.var_mens_s_e_nacion : "");
  const [var_ia_s_e_nacion, setVar_ia_s_e_nacion] = useState(typeof obj !== "undefined" ? obj.var_ia_s_e_nacion : "");
  const [valor_con_est_chaco, setValor_con_est_chaco] = useState(typeof obj !== "undefined" ? obj.valor_con_est_chaco : "");
  const [var_mens_c_e_chaco, setVar_mens_c_e_chaco] = useState(typeof obj !== "undefined" ? obj.var_mens_c_e_chaco : "");
  const [var_ia_c_e_chaco, setVar_ia_c_e_chaco] = useState(typeof obj !== "undefined" ? obj.var_ia_c_e_chaco : "");
  const [valor_con_est_nacion, setValor_con_est_nacion] = useState(typeof obj !== "undefined" ? obj.valor_con_est_nacion : "");
  const [var_mens_c_e_nacion, setVar_mens_c_e_nacion] = useState(typeof obj !== "undefined" ? obj.var_mens_c_e_nacion : "");
  const [var_ia_c_e_nacion, setVar_ia_c_e_nacion] = useState(typeof obj !== "undefined" ? obj.var_ia_c_e_nacion : "");
